  ...
  return (
    ...
    >
      ...
      >
        ...
        <Carousel photos={[{url: nightmarket, credit: 'Shu-Hua Chang'}]}/>
        <p>
        ...
        ingredientSections={[
          ...
          },
          {
            ...
            ingredients: [
              ...
              {quantity: '1', unit: 'tbs', name: 'black pepper', modifier: 'ground'},
        ...
        steps={[
          ...
          },
          {
            ...
            photos: [
              ...
              {url: kneading3, caption: 'The dough is done kneading, one it’s smooth.'},
              {url: kneading4, caption: 'The dough has sufficiently risen, once it’s double in size'}, 
            ],
          ...
          },
          {
            ...
            description: (
              <div>
                ...
                <p>You’re now ready to roll out the dough. Roll the dough to 8” by 18”—the exact measurements don’t matter since the dough will continue to be shaped and stretched later—just try to keep it a rough rectangle.</p>
              </div>
            ),
