  ...
  return (
    <Page title="Boba" nextPost="/bowl" previousPost="/bing_recipe" volume="/">
      <Gallery 
        title="Boba" 
        author="Jessica Lin"
        description="SincGrowing up as a third culture kid in Singapore, I have always had a mixed sense of “home.” Maybe because the things I love are spread across the globe: my family's in Taiwan, my memories are in Singapore, and my core is in San Francisco. However, throughout the years, I have found a constant familiarity in the simplest comfort: bubble tea. Or boba tea. Or pearl milk tea. Or 珍珠奶茶. Just like how this deliciously satisfying drink has different names in different places, the way boba fit into my life evolved with time and through different life stages."
        images={[
